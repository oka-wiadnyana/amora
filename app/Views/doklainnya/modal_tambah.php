    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('doklainnya/insert' . ($data ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_dokumen" class="form-control" value="<?= $data ? $data['nama_dokumen'] : ""; ?>">
                    </div>
                    <div class="mb-3">
