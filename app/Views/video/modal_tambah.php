    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('video/insert' . ($data ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>



                    <div class="form-group">
                        <label for="tanggal">Nama Video</label>
                        <input type="text" name="nama_video" class="form-control" value="<?= $data ? $data['nama_video'] : ""; ?>">
                    </div>
                    <div class="mb-3">
