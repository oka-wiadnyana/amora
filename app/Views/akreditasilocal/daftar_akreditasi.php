  ...
  <script>
    $(document).ready(function() {
      ...
      let getDataApm = (area = null) => {
        $.ajax({
          type: "post",
          url: "<?= base_url('akreditasilocal/getDataApm'); ?>",
          data: {
            area,
    ...
    <tr>
                ...
                <td>${element.bobot}</td>
                <td><a href="" class="btn btn-primary btn-link" data-nomor="${element.nomor}">Link</a> <a href="" class="btn btn-success btn-tambah" data-id="${element.id}">Tambah</a></td>
              </tr>
    `
              )
            });
      ...
      $('.tbody-akreditasi').on('click', '.btn-tambah', function(e) {
        ...
        $.ajax({
          type: "post",
          url: "<?= base_url('akreditasilocal/modal_upload_doc'); ?>",
          data: {
            id
          },
          dataType: "json",
      ...
      $('.tbody-akreditasi').on('click', '.btn-link', function(e) {
        ...
        $.ajax({
          type: "post",
          url: "<?= base_url('akreditasilocal/modal_link'); ?>",
          data: {
            nomor,
            semester,
            tahun
      ...
      $('.btn-preview').click(function(e) {
        ...
        $.ajax({
          type: "get",
          url: "<?= base_url('akreditasilocal/modal_preview'); ?>",
