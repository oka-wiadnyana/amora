          ...
          <tbody class="">
            ...
            <?php foreach ($data as $d) : ?>
              <tr>
                ...
                <td><?= $d['semester']; ?></td>
                <td><?= $d['tahun']; ?></td>
                <td><a href="<?= base_url('ass_internal_local_file/' . $d['nama_file']); ?>" class="btn btn-secondary <?= !$d['nama_file'] ? 'disabled' : ''; ?>" target="_blank">File</a> <a class="btn btn-danger btn-hapus <?= !$d['nama_file'] ? 'disabled' : ''; ?>" data-id="<?= $d['id']; ?>">Hapus</a></td>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.tambah-ass').click(function(e) {
        ...
        $.ajax({
          type: "get",
          url: "<?= base_url('akreditasilocal/modal_upload_internal'); ?>",
        ...
        $(this).click(function(e) {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              $.ajax({
                type: "post",
                url: "<?= base_url('akreditasilocal/hapus_internal'); ?>",
                data: {
                  id
                },
                dataType: "json",
