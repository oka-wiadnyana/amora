<div class="modal" id="modal_upload_doc" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Nomor APM : <?= $data['nomor']; ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="form-upload-file" method="post" enctype="multipart/form-data" action="<?= base_url('akreditasilocal/upload_doc'); ?>">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" name="file_apm">
                                <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="id" value="<?= $data['id']; ?>">
                    <input type="hidden" name="nomor_apm" value="<?= $data['nomor']; ?>">
