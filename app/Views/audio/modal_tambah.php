    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('audio/insert' . ($data ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>



                    <div class="form-group">
                        <label for="tanggal">Nama Audio</label>
                        <input type="text" name="nama_audio" class="form-control" value="<?= $data ? $data['nama_audio'] : ""; ?>">
                    </div>
                    <div class="mb-3">
