    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('monevzi/insert_laporan' . ($data_laporan ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_dokumen" id="" class="form-select">
                            ...
                            <option value="monev" <?= $data_laporan && $data_laporan['jenis_dokumen'] == 'monev' ? "selected" : ''; ?>>Monev</option>
                            <option value="tindak_lanjut" <?= $data_laporan && $data_laporan['jenis_dokumen'] == 'tindak_lanjut' ? "selected" : ''; ?>>TL</option>
