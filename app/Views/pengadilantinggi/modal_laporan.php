    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('pengadilantinggi/insert_laporan' . ($data_laporan ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="form-group">
                        ...
                        <select name="semester" id="" class="form-select">
                            ...
                            <?php foreach ($semesters as $semester) : ?>
                                <option value="<?= $semester; ?>" <?= $data_laporan && $data_laporan['semester'] == $semester ? "selected" : ''; ?>><?= $semester; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
