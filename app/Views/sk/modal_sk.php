            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('suratkeputusan/upload_sk' . ($data_sk ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_sk" class="form-control" value="<?= ($data_sk) ? $data_sk['tanggal_sk'] : ""; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" class="form-control" value="<?= ($data_sk) ? $data_sk['keterangan'] : ""; ?>">
                    </div>
                    <div class="form-group">
