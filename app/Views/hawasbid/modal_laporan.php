    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('hawasbid/insert_laporan' . ($data_laporan ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_laporan" id="" class="form-select">
                            ...
                            <option value="monev" <?= $data_laporan && $data_laporan['jenis_laporan'] == 'monev' ? "selected" : ''; ?>>Monev</option>
