    ...
    <div class="tab-pane fade show active" id="nav-gugatan" role="tabpanel" aria-labelledby="nav-gugatan-tab">
      <div class="row mb-2">
        <div class="row mb-2 px-1 mx-auto">
          <div class="col d-flex flex-column bg-success shadow text-white  rounded-3 py-1">
            <div class="col">
              Majelis I
            </div>
            <div class="col">
      ...
      <div class="row mb-2">
        ...
        <div class="table-responsive bg-white p-2 rounded-3 shadow">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <?php foreach ($data_gs as $key => $value) : ?>
            ...
            <tbody>
              <?php foreach ($data_permohonan as $key => $value) : ?>
                ...
                <tr>
                  ...
                  <?php foreach ($value['permohonan'] as $v) : ?>
