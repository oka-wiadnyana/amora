    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-upload-file" method="post" action="<?= base_url('briefing/insert_laporan' . ($data_laporan ? '/ubah' : '')); ?>" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_laporan" id="" class="form-select">
                            ...
                            <option value="briefing" <?= $data_laporan && $data_laporan['jenis_laporan'] == 'briefing' ? "selected" : ''; ?>>Briefing</option>
                            <option value="evaluasi" <?= $data_laporan && $data_laporan['jenis_laporan'] == 'evaluasi' ? "selected" : ''; ?>>Evaluasi</option>
