                    ...
                    <tbody>
                        ...
                        <?php foreach ($data_file as $file) : ?>
                            <tr>
                                ...
                                <td><a href="<?= base_url('file_dokumen_zi/' . $file['file']); ?>" class="btn btn-success" target="_blank"><span class="mdi mdi-arrow-down-bold"></span></a> <a href="" data-id="<?= $file['id']; ?>" class="ms-2 btn btn-danger delete-btn"><span class="mdi mdi-trash-can"></span></td>
    ...
    $('.delete-btn').click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "post",
                    url: "<?= base_url('dokumenzi/delete_file_reform'); ?>",
                    data: {
                        id
                    },
                    dataType: "json",
                    success: function(response) {
                        ...
                        $(location).attr('href', '<?= base_url('dokumenzi/data_reform/' . current_url(true)->getSegment(6)); ?>');
                    }
                });
            }
        })
