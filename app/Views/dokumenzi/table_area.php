      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-1 align-items-center p-0">
            <h4 class="my-auto card-title">Dokumen ZI</h4>
          </div>
          <div class="col-md-2">
                ...
                <?php foreach ($data as $key => $value) : ?>
                  ...
                  <?php foreach ($value as $key2 => $value2) : ?>
                    <tr>
                      ...
                      <td colspan="2"><strong><?= $sub_area[$key2]; ?></strong></td>
                    </tr>
...
<script>
  $(document).ready(function() {
    $('.upload-btn').click(function(e) {
      ...
      $.ajax({
        type: "post",
        url: "<?= base_url('dokumenzi/modal_upload/' . $area); ?>",
        data: {
          kode
        },
        dataType: "json",
    ...
    $('.file-btn').click(function(e) {
      ...
      $.ajax({
        type: "post",
        url: "<?= base_url('dokumenzi/modal_file/' . $area); ?>",
        data: {
          kode,
          tahun
        },
