...
$routes->group('ptsp', static function ($routes) {
    ...
    $routes->get('wasbid', [Ptsp::class, 'wasbid_ptsp']);
    $routes->post('data_hawasbid_datatable/(:any)', [Ptsp::class, 'data_hawasbid_datatable']);
    $routes->get('modal_laporan_wasbid', [Ptsp::class, 'modal_laporan_wasbid']);
    $routes->post('modal_laporan_wasbid', [Ptsp::class, 'modal_laporan_wasbid']);
    $routes->post('insert_laporan_wasbid', [Ptsp::class, 'insert_laporan_wasbid']);
    $routes->post('insert_laporan_wasbid/(:any)', [Ptsp::class, 'insert_laporan_wasbid']);
    // $routes->get('logout', [Panitera::class, 'logout']);
});
