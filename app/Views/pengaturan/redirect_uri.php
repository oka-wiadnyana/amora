...
<div class="content-wrapper">
    ...
    <div class="card">
      <div class="card-body">
        <div class="col-md-6 mb-3 p-0">
          <div class="col p-0">
            <h4 class="my-auto card-title">Redirect URI</h4>
          </div>
        ...
        <div class="row mb-2">
          <div class="col">
            ...
            <a href="" class="btn btn-info tambah-uri">Tambah</a>
          </div>
        </div>



        <table class="table table-bordered mt-2 pt-2" id="table-uri">
          <thead>
            <tr>
              <th style="border-top: 1px solid grey;"> Nomor </th>
              <th style="border-top: 1px solid grey;"> Method </th>

              <th style="border-top: 1px solid grey;"> URI </th>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.tambah-uri').click(function(e) {
        e.preventDefault();
        $.ajax({
          type: "get",
          url: "<?= base_url('pengaturan/modal_uri'); ?>",

          dataType: "json",
          success: function(response) {
            $('#modal').html(response);
            $('#modal_uri').modal('show');
          }
        });
      })
        ...
        $(this).click(function(e) {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              $.ajax({
                type: "post",
                url: "<?= base_url('pengaturan/hapus_uri'); ?>",
                data: {
                  id
                },
                dataType: "json",
                success: function(response) {
                  ...
                  $(location).attr('href', `<?= base_url('pengaturan/redirect_uri'); ?>`);
                }
              });
            }
          })
