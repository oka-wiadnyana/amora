                ...
                <form id="form-upload-file" method="post" action="<?= base_url('pengaturan/insert_bagian' . ($data_bagian ? '/ubah' : '')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="level" class="form-control">
                            ...
                            <option value="mr" <?= ($data_bagian != null && $data_bagian['level'] == 'mr') ? "selected" : ""; ?>>Manager Representative</option>
                            <option value="administrator" <?= ($data_bagian != null && $data_bagian['level'] == 'administrator') ? "selected" : ""; ?>>Admin</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="is_sub_unit">Apakah Sub Unit?</label>
                        <select name="is_sub_unit" class="form-control">
                            <option selected disabled>Pilih </option>
                            <option value="Y" <?= ($data_bagian != null && $data_bagian['is_sub_unit'] == 'Y') ? "selected" : ""; ?>>Ya</option>
                            <option value="T" <?= ($data_bagian != null && $data_bagian['is_sub_unit'] == 'T') ? "selected" : ""; ?>>Tidak</option>

                        </select>
                    </div>
                    <input type="hidden" name="id" value="<?= ($data_bagian) ? $data_bagian['id'] : ""; ?>">
                    <input type="hidden" name="level_lama" value="<?= ($data_bagian) ? $data_bagian['level'] : ""; ?>">
