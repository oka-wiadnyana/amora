...
<div class="content-wrapper">
  ...
  <nav class="mt-2">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      ...
      <button class="nav-link button_jenis_ptsp" id="nav-monev-tab" data-toggle="tab" data-target="#nav-monev" type="button" role="tab" aria-controls="nav-monev" aria-selected="false" data-jenis='monev'>Monev</button>
