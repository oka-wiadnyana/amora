...
class Pengaturan extends BaseController
{
    ...
    public function insert_bagian($ubah = null)
    {
        ...
        // dd($level);
        if ($ubah == 'ubah') {
            if (db_connect()->table('bagian')->where('id', $id)->update(['nama_bagian' => $nama_bagian, 'level' => $level])) {
            ...
            if (db_connect()->table('bagian')->insert(['nama_bagian' => $nama_bagian, 'level' => $level])) {
